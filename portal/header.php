  ...
  <body>
    <nav class="navbar navbar-default navbar-static-top" role="navigation" id="patient-header">
      <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#patient-nav" aria-expanded="false" aria-controls="navbar">
    ...
    <div class="collapse navbar-collapse pull-right" id="patient-nav">
      <ul class="nav navbar-nav pull-right">
          ...
          <li><a href="appointments.php"><i class="fa fa-calendar-o fa-fw"></i>Appointments</a></li>
          ...
          <li><a href="#"><span class="label label-success pull-right">5</span><i class="fa fa-envelope fa-fw"></i>Messages</a></li>
